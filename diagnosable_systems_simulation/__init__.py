...
Quick start (stub backend, no extra dependencies)::
    ...
    from diagnosable_systems_simulation.backends import StubBackend
...
With ngspice (``pip install diagnosable-systems-simulation[spice]``)::

    from diagnosable_systems_simulation.backends import PySpiceBackend
    system = build_three_cubes_system(backend=PySpiceBackend())
"""
